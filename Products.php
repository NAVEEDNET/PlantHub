...
<body>
    ...
    // Fetch the status_row if there's a result
        ...
        ?> 
          ...
          <div class="product text-center col-lg-3 col-md-4 col-sm-6">
            ...
            <h5 class="p-price">Rs <?php echo $row['plant_price']; ?></h5>
            <a href=<?php echo "product_details.php?plant_id=" . $row['plant_id']; ?>>
        ...
        <p>Sorry, but nothing matched your Filter terms.</p>
      <?php } ?>
  ...
  <nav aria-label="page navigation">
    <ul class="pagination mt-5">
      ...
      <?php if ($page_no >= 3) { ?>
        <li class="page-item"><a class="page-link" href="?page_no=3">...</a></li>
